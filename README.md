...
BQ-1 (Tren Finansial & Churn): Apakah terdapat perbedaan yang signifikan pada rata-rata Total Spend antara pelanggan yang churn dan pelanggan yang bertahan selama periode pencatatan data?

BQ-2 (Karakteristik Demografi): Kelompok pelanggan berdasarkan usia dan jenis kelamin manakah yang memiliki tingkat churn tertinggi?

BQ-3 (Loyalitas & Perilaku): Bagaimana pengaruh lama berlangganan (Tenure) dan frekuensi pembelian (Purchase Frequency) terhadap keputusan pelanggan untuk melakukan churn?

BQ-4 (Pembatalan & Churn): Apakah jumlah pembatalan transaksi (Cancellations Count) memiliki hubungan terhadap kecenderungan pelanggan untuk melakukan churn?
